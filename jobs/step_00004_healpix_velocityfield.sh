...
home=/data/home/mbreton/magrathea_pathfinder/bin/ # executable directory
EXEC=$home/hmaps_velocityfield
...
healpix_outputdir='healpix_maps_velocityfield'
conedir='conedir'
...
partdir = $DIR/post/slicer_ncoarse/$inputconepart/# Directory containing DM particles (for velocityfield)
...
stop_ray = redshift # Important, corresponds to the stop criterion of bundles.    Possible cases : redshift, lambda, a, t, r
#########################

###### HEALPIX ########
nside = 64 # total of 12*nside*nside pixels
map_components = lensing, steps, dr # dens_max should not work very well here
...
jacobiantype = bundle # Computation of the jacobian matrix : "infinitesimal" or "bundle"
## if jacobiantpe = 'bundle' :
stop_bundle = lambda # Important, corresponds to the stop criterion of bundles (if jacobiantype = 'bundle'). Possible cases : redshift, lambda, a, t, r, plane
...
# Only with -DVELOCITYFIELD
v0x = 0 
v0y = 0 
v0z = 0
velocity_field = tsc # interpolation for the velocity field:  "cic" (Cloud-In-Cell), "tsc" (Triangular Shaped Cloud)
