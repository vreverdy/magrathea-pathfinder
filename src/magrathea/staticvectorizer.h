...
namespace magrathea {
    ...
    public:
        ...
        inline Crtp<Type, Parameters...>& operator=(const std::initializer_list<OtherType>& rhs);
        template<class Misc>
        inline Crtp<Type, Parameters...>& operator=(const Misc& rhs);
        //@}
    ...
    public:
        ...
        inline Crtp<Type, Parameters...>& operator+=(const GenericType& rhs);
        template<class GenericType>
        inline Crtp<Type, Parameters...>& operator-=(const GenericType& rhs);
        template<class GenericType>
        inline Crtp<Type, Parameters...>& operator*=(const GenericType& rhs);
    ...
    public:
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator+(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator-(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator*(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        ...
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator^(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<Type, Parameters...> operator<<(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<Type, Parameters...> operator>>(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<bool, Parameters...> operator&&(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<bool, Parameters...> operator||(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<bool, Parameters...> operator==(const StaticVectorizer<Kind, Size, Crtp, OtherType, Parameters...>& rhs) const;
    ...
    public:
        ...
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator+(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator-(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator*(const OtherType& rhs) const;
        ...
        inline Crtp<typename std::common_type<Type, OtherType>::type, Parameters...> operator^(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<Type, Parameters...> operator<<(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<Type, Parameters...> operator>>(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<bool, Parameters...> operator&&(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<bool, Parameters...> operator||(const OtherType& rhs) const;
        template<typename OtherType, class = typename std::enable_if<(!std::is_base_of<Vectorizer, OtherType>::value) && (std::is_convertible<OtherType, Type>::value)>::type>
        inline Crtp<bool, Parameters...> operator==(const OtherType& rhs) const;
    ...
    public:
        ...
        friend inline SelfCrtp<typename std::common_type<SelfType, OtherType>::type, SelfParameters...> operator+(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<typename std::common_type<SelfType, OtherType>::type, SelfParameters...> operator-(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<typename std::common_type<SelfType, OtherType>::type, SelfParameters...> operator*(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        ...
        friend inline SelfCrtp<typename std::common_type<SelfType, OtherType>::type, SelfParameters...> operator^(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<OtherType, SelfParameters...> operator<<(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<OtherType, SelfParameters...> operator>>(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<bool, SelfParameters...> operator&&(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<bool, SelfParameters...> operator||(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename OtherType, typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters, class>
        friend inline SelfCrtp<bool, SelfParameters...> operator==(const OtherType& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
    ...
    public:
        ...
        inline Crtp<Type, Parameters...>& assign(const std::initializer_list<OtherType>& source, const Misc&... misc);
        template<class... Misc>
        inline Crtp<Type, Parameters...>& assign(const Misc&... misc);
        template<typename OtherType, class... Misc, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<Type, Parameters...>& fill(const std::initializer_list<OtherType>& source, const Misc&... misc);
        template<class... Misc>
        inline Crtp<Type, Parameters...>& fill(const Misc&... misc);
        template<typename OtherType, class... Misc, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Crtp<Type, Parameters...> replace(const std::initializer_list<OtherType>& source, const Misc&... misc);
        template<class... Misc>
        inline Crtp<Type, Parameters...> replace(const Misc&... misc);
        template<class GenericType>
        inline Crtp<Type, Parameters...>& put(const GenericType& source, const unsigned int pos, const unsigned int num = 1);
        template<class GenericType>
        inline Crtp<Type, Parameters...> change(const GenericType& source, const unsigned int pos, const unsigned int num = 1);
        //@}
    ...
    public:
        ...
        inline Crtp<Type, Parameters...>& nullify(const Location&... location);
        template<class... Location>
        inline Crtp<Type, Parameters...>& swap(StaticVectorizer<Kind, Size, Crtp, Type, Parameters...>& rhs, const Location&... location);
        ...
        inline Crtp<OtherType, Parameters...> cast() const;
        //@}
    ...
    public:
        ...
        template<class GenericType>
        inline bool eq(const GenericType& rhs) const;
        template<class GenericType>
        inline bool ne(const GenericType& rhs) const;
        //@}
    ...
    public:
        ...
        inline const Type& min(const Mask& bitmask = Mask()) const;
        template<class Mask = std::true_type, class = typename std::enable_if<(std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value)>::type>
        inline const Type& max(const Mask& bitmask = Mask()) const;
        //@}
    ...
    public:
        ...
        inline Crtp<Type, Parameters...>& modify(Function&& f, Args&&... args);
        ...
        inline Crtp<Type, Parameters...>& modify(const Mask& bitmask, Function&& f, Args&&... args);
        template<typename Return = Type, class Function, class... Args, class = typename std::enable_if<!std::is_base_of<Vectorizer, typename std::decay<Function>::type>::value>::type>
        inline Crtp<Return, Parameters...> apply(Function&& f, Args&&... args) const;
        template<typename Return = Type, class Mask, class Function, class... Args, class = typename std::enable_if<(std::is_base_of<Vectorizer, Mask>::value) && (!std::is_base_of<Vectorizer, typename std::decay<Function>::type>::value)>::type>
        inline Crtp<Return, Parameters...> apply(const Mask& bitmask, Function&& f, Args&&... args) const;
        ...
        inline Return reduce(Function&& f = Function(), const Return& init = Return()) const;
        ...
        inline Return reduce(const Mask& bitmask, Function&& f = Function(), const Return& init = Return()) const;
        ...
        inline Crtp<Return, Parameters...> combine(Function&& f, const StaticVectorizer<Kind, Size, Crtp, Arg, Parameters...>& arg, const StaticVectorizer<Kind, Size, Crtp, Args, Parameters...>&... args) const;
        template<typename Return = Type, class Function>
        inline Crtp<Return, Parameters...> combine(Function&&) const;
        //@}
    ...
    public:
        ...
        inline unsigned int count(const Reference& r = true, const Mask& bitmask = Mask()) const;
        ...
        inline unsigned int count(Function&& f, const Mask& bitmask = Mask()) const;
        template<class Reference = bool, class Mask = std::true_type, class = typename std::enable_if<((std::is_convertible<Type, Reference>::value) || (std::is_base_of<Vectorizer, Reference>::value)) && ((std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value))>::type>
        inline bool all(const Reference& r = true, const Mask& bitmask = Mask()) const;
        template<class Function, class Mask = std::true_type, class = typename std::enable_if<((!std::is_convertible<Type, typename std::decay<Function>::type>::value) && (!std::is_base_of<Vectorizer, typename std::decay<Function>::type>::value)) && ((std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value))>::type>
        inline bool all(Function&& f, const Mask& bitmask = Mask()) const;
        template<class Reference = bool, class Mask = std::true_type, class = typename std::enable_if<((std::is_convertible<Type, Reference>::value) || (std::is_base_of<Vectorizer, Reference>::value)) && ((std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value))>::type>
        inline bool any(const Reference& r = true, const Mask& bitmask = Mask()) const;
        template<class Function, class Mask = std::true_type, class = typename std::enable_if<((!std::is_convertible<Type, typename std::decay<Function>::type>::value) && (!std::is_base_of<Vectorizer, typename std::decay<Function>::type>::value)) && ((std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value))>::type>
        inline bool any(Function&& f, const Mask& bitmask = Mask()) const;
        template<class Reference = bool, class Mask = std::true_type, class = typename std::enable_if<((std::is_convertible<Type, Reference>::value) || (std::is_base_of<Vectorizer, Reference>::value)) && ((std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value))>::type>
        inline bool none(const Reference& r = true, const Mask& bitmask = Mask()) const;
        template<class Function, class Mask = std::true_type, class = typename std::enable_if<((!std::is_convertible<Type, typename std::decay<Function>::type>::value) && (!std::is_base_of<Vectorizer, typename std::decay<Function>::type>::value)) && ((std::is_base_of<Vectorizer, Mask>::value) || (std::is_same<std::true_type, Mask>::value))>::type>
        inline bool none(Function&& f, const Mask& bitmask = Mask()) const;
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        template<typename SelfKind, unsigned int SelfSize, template<typename, SelfKind...> class SelfCrtp, typename SelfType, SelfKind... SelfParameters>
        friend std::istream& operator>>(std::istream& lhs, StaticVectorizer<SelfKind, SelfSize, SelfCrtp, SelfType, SelfParameters...>& rhs);
        //@}
    ...
    public:
        ...
        static inline Crtp<bool, Parameters...> mask(const Container& container);
        template<typename OtherType, class... Misc, class = typename std::enable_if<std::is_convertible<OtherType, bool>::value>::type>
        static inline Crtp<bool, Parameters...> mask(const std::initializer_list<OtherType>& source, const Misc&... misc);
        template<class... Misc, class = typename std::enable_if<sizeof...(Misc) != 0>::type>
        static inline Crtp<bool, Parameters...> mask(const Misc&... misc);
        //@}
    ...
    template<typename Kind, unsigned int Size, template<typename, Kind...> class Crtp, typename Type, Kind... Parameters>
    inline StaticVectorizer<Kind, Size, Crtp, Type, Parameters...>::~StaticVectorizer() = default;
    // -------------------------------------------------------------------------- //
