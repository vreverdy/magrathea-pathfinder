...
namespace magrathea {
    ...
    public:
        ...
        inline Timer(const bool running0 = false, const Duration& record0 = Duration(), const ReferenceTimePoint& reference0 = ReferenceTimePoint(), const BeginningTimePoint& beginning0 = BeginningTimePoint(), const EndingTimePoint& ending0 = EndingTimePoint());
        template<typename OtherType, class OtherPeriod>
        inline Timer(const Timer<OtherType, OtherPeriod, Clock>& source);
        //@}
    ...
    public:
        template<typename OtherType, class OtherPeriod>
        inline Timer<Type, Period, Clock>& operator=(const Timer<OtherType, OtherPeriod, Clock>& rhs);
    ...
    public:
        template<class Duration = Type, class ReferenceTimePoint = std::true_type, class BeginningTimePoint = std::true_type, class EndingTimePoint = std::true_type>
        inline Timer<Type, Period, Clock>& assign(const bool running0 = false, const Duration& record0 = Duration(), const ReferenceTimePoint& reference0 = ReferenceTimePoint(), const BeginningTimePoint& beginning0 = BeginningTimePoint(), const EndingTimePoint& ending0 = EndingTimePoint());
        template<typename OtherType, class OtherPeriod>
        inline Timer<Type, Period, Clock>& assign(const Timer<OtherType, OtherPeriod, Clock>& source);
        //@}
    ...
    public:
        ...
        inline Timer<OtherType, OtherPeriod, Clock> cast() const;
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const Timer<SelfType, SelfPeriod, SelfClock>& rhs);
        //@}
    ...
    public:
        ...
        static inline std::chrono::duration<Type, Period> wait(const Duration& delay = Duration(1), Counter&& counter = Counter());
        template<typename Counter, class Function, class... Args>
        static inline std::chrono::duration<Type, Period> benchmark(const Counter& counter, Function&& f, Args&&... args);
        //@}
