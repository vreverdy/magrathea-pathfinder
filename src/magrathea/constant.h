...
namespace magrathea {
    ...
    public:
        ...
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != 1>::type>
        constexpr Constant(const Types... source);
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        constexpr Constant(const OtherType source);
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        constexpr Constant(const Constant<OtherType, Size> source);
        template<typename OtherType, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        constexpr Constant(const std::array<OtherType, Size> source);
    ...
    public:
        ...
        constexpr const Constant<Type, Size> operator()(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> operator()(const Types... values) const;
    ...
    public:
        ...
        constexpr const Constant<Type, OtherSize> resize() const;
        constexpr const Constant<Type, Size> nullify() const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> set(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> set(const Types... values) const;
        ...
        template<typename OtherType = Type>
        constexpr const std::array<OtherType, Size> data() const;
        template<typename OtherType>
        constexpr const Constant<OtherType, Size> cast() const;
    ...
    public:
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> inv(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> inv(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> opp(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> opp(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> abs(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> abs(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> sgn(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> sgn(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> sq(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> sq(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> cb(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> cb(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> isqrt(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> isqrt(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> icbrt(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> icbrt(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> ilog2(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> ilog2(const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> ilog10(const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> ilog10(const Types... values) const;
        template<class Ratio = std::ratio<1>, typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> si(const Types&... values) const;
        template<class Ratio = std::ratio<1>, typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> si(const Types... values) const;
        //@}
    ...
    public:
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> add(const Type rhs, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> add(const Type, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> sub(const Type rhs, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> sub(const Type, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> mul(const Type rhs, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> mul(const Type, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> div(const Type rhs, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> div(const Type, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> mod(const Type rhs, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> mod(const Type, const Types... values) const;
        //@}
    ...
    public:
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> ratio(const Type num, const Type den, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> ratio(const Type, const Type, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> pow(const int n, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> pow(const int, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> irt(const int n, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> irt(const int, const Types... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) != Size>::type>
        constexpr const Constant<Type, Size> ilog(const int b, const Types&... values) const;
        template<typename... Types, class = typename std::enable_if<sizeof...(Types) == Size>::type>
        constexpr const Constant<Type, Size> ilog(const int, const Types... values) const;
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const Constant<SelfType, SelfSize>& rhs);
        //@}
    ...
    public:
        ...
        static constexpr const std::array<OtherType, OtherSize> transmute(const Array source, const Types&... values);
        template<typename OtherType, unsigned int OtherSize, class Array, typename... Types, class = typename std::enable_if<sizeof...(Types) == OtherSize>::type>
        static constexpr const std::array<OtherType, OtherSize> transmute(const Array, const Types... values);
        ...
        static constexpr OtherType metairt(const OtherType x, const int n, const IntegralType low = IntegralType(), const IntegralType high = IntegralType(), const IntegralType mid = IntegralType());
        template<typename OtherType, class = typename std::enable_if<std::is_arithmetic<OtherType>::value>::type>
    ...
    constexpr const Constant<Type, Size> Constant<Type, Size>::mod(const Type rhs, const Types&... values) const {
        return mod(rhs, values..., (std::is_floating_point<Type>::value) ? (_data[sizeof...(values)] - static_cast<long long int>(_data[sizeof...(values)] / rhs) * rhs) : (static_cast<typename std::conditional<std::is_floating_point<Type>::value, long long int, Type>::type>(_data[sizeof...(values)]) % static_cast<typename std::conditional<std::is_floating_point<Type>::value, long long int, Type>::type>(rhs)));
    }
