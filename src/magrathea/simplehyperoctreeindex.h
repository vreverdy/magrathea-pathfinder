...
namespace magrathea {
    ...
    public:
        ...
        explicit inline SimpleHyperOctreeIndex(const String& source);
        //@}
    ...
    public:
        ...
        template<class String, class = typename std::enable_if<(std::is_convertible<String, std::string>::value) && (std::is_convertible<decltype(std::declval<String>()[0]), char>::value)>::type>
        inline SimpleHyperOctreeIndex<Type, Dimension, Bits>& operator=(const String& rhs);
    ...
    public:
        ...
        template<class String, class = typename std::enable_if<(std::is_convertible<String, std::string>::value) && (std::is_convertible<decltype(std::declval<String>()[0]), char>::value)>::type>
        inline SimpleHyperOctreeIndex<Type, Dimension, Bits>& assign(const String& source);
        //@}
    ...
    public:
        ...
        inline Type linear(const Level ilvl = Level()) const;
        inline Type zcurve() const;
        template<class Level = std::true_type, class = typename std::enable_if<((std::is_same<Level, std::true_type>::value) || (std::is_convertible<Level, int>::value)) && (!std::is_floating_point<Level>::value)>::type>
        inline Type site(const Level ilvl = Level()) const;
        template<unsigned int From = 0, unsigned int To = Dimension - 1, unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class = typename std::enable_if<(From <= Mid) && (Mid <= To) && (To <= Dimension)>::type>
        inline Type coordinate(const unsigned int idim) const;
        //@}
    ...
    public:
        ...
        inline Kind position(const unsigned int idim, const Level ilvl = Level()) const;
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, unsigned int From = 0, unsigned int To = Dimension - 1, unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class Reference = typename std::ratio_subtract<Position, typename std::ratio_divide<Extent, std::ratio<2>>>, class Level = std::true_type, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0) && (From <= Mid) && (Mid <= To) && (To <= Dimension) && (((std::is_same<Level, std::true_type>::value) || (std::is_convertible<Level, int>::value)) && (!std::is_floating_point<Level>::value))>::type>
        inline Kind center(const unsigned int idim, const Level ilvl = Level()) const;
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, unsigned int From = 0, unsigned int To = Dimension - 1, unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class Reference = typename std::ratio_subtract<Position, typename std::ratio_divide<Extent, std::ratio<2>>>, class Level = std::true_type, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0) && (From <= Mid) && (Mid <= To) && (To <= Dimension) && (((std::is_same<Level, std::true_type>::value) || (std::is_convertible<Level, int>::value)) && (!std::is_floating_point<Level>::value))>::type>
        inline Kind minimum(const unsigned int idim, const Level ilvl = Level()) const;
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, unsigned int From = 0, unsigned int To = Dimension - 1, unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class Reference = typename std::ratio_subtract<Position, typename std::ratio_divide<Extent, std::ratio<2>>>, class Level = std::true_type, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0) && (From <= Mid) && (Mid <= To) && (To <= Dimension) && (((std::is_same<Level, std::true_type>::value) || (std::is_convertible<Level, int>::value)) && (!std::is_floating_point<Level>::value))>::type>
        inline Kind maximum(const unsigned int idim, const Level ilvl = Level()) const;
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0)>::type>
        inline Kind extent() const;
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0)>::type>
        inline Kind length() const;
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0)>::type>
        inline Kind volume() const;
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const SimpleHyperOctreeIndex<SelfType, SelfDimension, SelfBits>& rhs);
        //@}
        ...
        //@{
    public:
        template<unsigned int From = 0, unsigned int To = Bits / (Dimension + 1), unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class = typename std::enable_if<(From <= Mid) && (Mid <= To) && (To <= Bits / (Dimension + 1))>::type>
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> delinearize(const unsigned int ilvl, const Type ilinear);
        template<unsigned int From = 0, unsigned int To = Bits / (Dimension + 1), unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class = typename std::enable_if<(From <= Mid) && (Mid <= To) && (To <= Bits / (Dimension + 1))>::type>
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> dezcurvify(const unsigned int ilvl, const Type izcurve);
        template<typename... Types, class = typename std::enable_if<((std::is_convertible<typename std::tuple_element<0, typename std::conditional<static_cast<bool>(sizeof...(Types)), std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>, std::tuple<Type>>::type>::type, Type>::value) ? (true) : (sizeof...(Types) == 1))>::type>
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> navigate(Types&&... isites);
        template<unsigned int From = 0, unsigned int To = Bits / (Dimension + 1), unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), typename... Types, class = typename std::enable_if<(From <= Mid) && (Mid <= To) && (To <= Bits / (Dimension + 1)) && ((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Type>::value) ? (sizeof...(Types) == Dimension) : (sizeof...(Types) == 1))>::type>
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> make(const unsigned int ilvl, Types&&... icoords);
        template<typename Kind = double, class Position = std::ratio<0>, class Extent = std::ratio<1>, unsigned int From = 0, unsigned int To = Bits / (Dimension + 1), unsigned int Mid = From + (To - From) / 2, bool Condition = (From != To), class Reference = typename std::ratio_subtract<Position, typename std::ratio_divide<Extent, std::ratio<2>>>, typename... Kinds, class = typename std::enable_if<(std::is_floating_point<Kind>::value) && (Position::den != 0) && (Extent::num >= 0) && (From <= Mid) && (Mid <= To) && (To <= Bits / (Dimension + 1)) && ((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Kinds>::type>::type...>>::type, Type>::value) ? (sizeof...(Kinds) == Dimension) : (sizeof...(Kinds) == 1))>::type>
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> compute(const unsigned int ilvl, Kinds&&... iposs);
        ...
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> cipher(Kinds&&... iposs);
        template<class... Indices>
        static constexpr SimpleHyperOctreeIndex<Type, Dimension, Bits> merge(const SimpleHyperOctreeIndex<Type, Dimension, Bits>& idx, Indices&&... idcs);
        //@}
    ...
    public:
        ...
        template<class Level = std::true_type, class = typename std::enable_if<((std::is_same<Level, std::true_type>::value) || (std::is_convertible<Level, int>::value)) && (!std::is_floating_point<Level>::value)>::type>
        static constexpr Type indices(const Level ilvl = Level(), const unsigned int nref = 0);
        template<class Level = std::true_type, class = typename std::enable_if<((std::is_same<Level, std::true_type>::value) || (std::is_convertible<Level, int>::value)) && (!std::is_floating_point<Level>::value)>::type>
        static constexpr Type subdivisions(const Level ilvl = Level());
        ...
        //@{
    public:
        template<class Template, class Function, class Tuple, typename... Kinds, class = typename std::enable_if<(sizeof...(Kinds) + 1 <= std::tuple_size<Template>::value)>::type>
        static constexpr Template apply(Function&& f, Tuple&& tuple, Kinds&&... values);
        template<class Template, class Function, class Tuple, typename... Kinds, class = typename std::enable_if<(sizeof...(Kinds) == std::tuple_size<Template>::value)>::type>
        static constexpr Template apply(Function&& f, const Tuple& tuple, Kinds&&... values);
        template<class Template, class Function, typename Kind, class = typename std::enable_if<std::is_convertible<Template, int>::value>::type>
        static constexpr Template apply(Function&& f, Kind&& value);
        template<typename Kind, class Operation = std::plus<Kind>, unsigned int Index = 0, class Tuple, bool Condition = (Index + 2 <= std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value), class = typename std::enable_if<(std::is_convertible<Kind, int>::value) && (std::is_convertible<typename std::result_of<Operation(Kind, Kind)>::type, Kind>::value) && (std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value >= 1)>::type>
        static constexpr Kind accumulate(Tuple&& tuple);
        template<typename Kind, class Operation = std::plus<Kind>, typename... Kinds, class = typename std::enable_if<(std::is_convertible<Kind, int>::value) && (std::is_convertible<typename std::result_of<Operation(Kind, Kind)>::type, Kind>::value)>::type>
        static constexpr Kind accumulate(const Kind value, const Kinds... values);
        template<typename Kind, class Operation = std::plus<Kind>, class = typename std::enable_if<(std::is_convertible<Kind, int>::value) && (std::is_convertible<typename std::result_of<Operation(Kind, Kind)>::type, Kind>::value)>::type>
        static constexpr Kind accumulate(const Kind value);
        template<typename Kind, int Exponent = 1, int One = 1, bool Greater = (Exponent > 1), bool Less = (Exponent < 0), bool Equal = (Exponent == 1), class = typename std::enable_if<std::is_convertible<Kind, int>::value>::type>
        static constexpr Kind pow(const Kind value);
        template<typename Integer, Integer Zero = Integer(), Integer One = Integer(1), Integer Ones = ~Zero, Integer Size = sizeof(Integer) * std::numeric_limits<unsigned char>::digits, class = typename std::enable_if<((std::is_integral<Integer>::value) ? (std::is_unsigned<Integer>::value) : (std::is_convertible<Integer, int>::value)) && (!std::is_floating_point<Integer>::value)>::type>
        static constexpr Integer block(const Integer location = Zero, const Integer length = Size);
        ...
        static constexpr Integer periodic(const Integer period = One, const Integer offset = Zero);
        ...
        static constexpr Integer comb(const Integer period = One, const Integer offset = Zero);
        ...
        static constexpr Integer nhp(const Integer value);
        ...
        static constexpr Integer bhsmask(const Integer value);
        ...
        static constexpr Integer lzcnt(const Integer value);
        ...
        static constexpr Integer tzcnt(const Integer value);
        ...
        static constexpr Integer popcnt(const Integer value);
        ...
        static constexpr Integer pext(const Integer value);
        template<typename Integer, Integer Mask = ~Integer(), Integer Step = Integer(), Integer Shift = Integer(), Integer One = Integer(1), Integer Condition = (Step + One <= sizeof(Integer) * std::numeric_limits<unsigned char>::digits), Integer Temporary = ((Condition) ? ((Mask >> Step) & (Condition)) : (Condition)), class = typename std::enable_if<((std::is_integral<Integer>::value) ? (std::is_unsigned<Integer>::value) : (std::is_convertible<Integer, int>::value)) && (!std::is_floating_point<Integer>::value)>::type>
        static constexpr Integer pdep(const Integer value);
        ...
        static constexpr Integer itlc(const Integer value);
    ...
    inline Kind SimpleHyperOctreeIndex<Type, Dimension, Bits>::extent() const {
        return Kind(Extent::num) / (Kind(Extent::den) * Kind(std::integral_constant<Type, 1>::value << level())); // WARNING : Extent not taken into account here
    }
