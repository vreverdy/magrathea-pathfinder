...
namespace magrathea {
    ...
    public:
        ...
        template<typename Type>
        static inline unsigned long long int rsize(const Type* const first, const Type* const last);
        template<typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline unsigned long long int rsize(const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        ...
        template<typename Type>
        static inline unsigned long long int rbytesize(const Type* const first, const Type* const last);
        template<typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline unsigned long long int rbytesize(const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        ...
        static inline unsigned int byteswap(const Types&...);
        template<bool Byteswap, typename... Types, class = typename std::enable_if<!Byteswap>::type>
        static inline unsigned int rbyteswap(const Types&...);
        template<bool Byteswap = true, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned int byteswap();
        template<bool Byteswap = true, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned int byteswap(std::tuple<>&);
        template<bool Byteswap = true, typename Type, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned int byteswap(Type& variable);
        template<bool Byteswap = true, typename Type, typename... Types, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned int byteswap(Type& variable, Types&... variables);
        template<bool Byteswap = true, typename Type, std::size_t Size, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned int byteswap(std::array<Type, Size>& container);
        template<bool Byteswap = true, unsigned int Current = 0, typename... Types, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned int byteswap(std::tuple<Types...>& container);
        template<bool Byteswap = true, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned long long int rbyteswap(const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<bool Byteswap = true, typename Type, class = typename std::enable_if<Byteswap>::type>
        static inline unsigned long long int rbyteswap(Type* const first, Type* const last);
        template<bool Byteswap = true, typename Type, class = typename std::enable_if<(Byteswap) && (!std::is_pointer<Type>::value)>::type>
        static inline unsigned long long int rbyteswap(const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        ...
        static inline bool write(std::ostream& stream);
        template<bool Byteswap = false>
        static inline bool write(std::ostream& stream, const std::tuple<>&);
        template<bool Byteswap = false, typename Type>
        static inline bool write(std::ostream& stream, const Type& variable);
        template<bool Byteswap = false, typename Type, typename... Types>
        static inline bool write(std::ostream& stream, const Type& variable, const Types&... variables);
        template<bool Byteswap = false, typename Type, std::size_t Size>
        static inline bool write(std::ostream& stream, const std::array<Type, Size>& container);
        template<bool Byteswap = false, unsigned int Current = 0, typename... Types>
        static inline bool write(std::ostream& stream, const std::tuple<Types...>& container);
        template<bool Byteswap = false>
        static inline bool rwrite(std::ostream& stream, const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<bool Byteswap = false, typename Type>
        static inline bool rwrite(std::ostream& stream, const Type* const first, const Type* const last);
        template<bool Byteswap = false, typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline bool rwrite(std::ostream& stream, const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        template<bool Byteswap = false>
        static inline bool read(std::istream& stream);
        template<bool Byteswap = false>
        static inline bool read(std::istream& stream, std::tuple<>&);
        template<bool Byteswap = false, typename Type>
        static inline bool read(std::istream& stream, Type& variable);
        template<bool Byteswap = false, typename Type, typename... Types>
        static inline bool read(std::istream& stream, Type& variable, Types&... variables);
        template<bool Byteswap = false, typename Type, std::size_t Size>
        static inline bool read(std::istream& stream, std::array<Type, Size>& container);
        template<bool Byteswap = false, unsigned int Current = 0, typename... Types>
        static inline bool read(std::istream& stream, std::tuple<Types...>& container);
        template<bool Byteswap = false>
        static inline bool rread(std::istream& stream, const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<bool Byteswap = false, typename Type>
        static inline bool rread(std::istream& stream, Type* const first, Type* const last);
        template<bool Byteswap = false, typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline bool rread(std::istream& stream, const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        template<bool Byteswap = false>
        static inline char*& write(char*& buffer);
        template<bool Byteswap = false>
        static inline char*& write(char*& buffer, const std::tuple<>&);
        template<bool Byteswap = false, typename Type>
        static inline char*& write(char*& buffer, const Type& variable);
        template<bool Byteswap = false, typename Type, typename... Types>
        static inline char*& write(char*& buffer, const Type& variable, const Types&... variables);
        template<bool Byteswap = false, typename Type, std::size_t Size>
        static inline char*& write(char*& buffer, const std::array<Type, Size>& container);
        template<bool Byteswap = false, unsigned int Current = 0, typename... Types>
        static inline char*& write(char*& buffer, const std::tuple<Types...>& container);
        template<bool Byteswap = false>
        static inline char*& rwrite(char*& buffer, const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<bool Byteswap = false, typename Type>
        static inline char*& rwrite(char*& buffer, const Type* const first, const Type* const last);
        template<bool Byteswap = false, typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline char*& rwrite(char*& buffer, const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        template<bool Byteswap = false>
        static inline char*& read(char*& buffer);
        template<bool Byteswap = false>
        static inline char*& read(char*& buffer, std::tuple<>&);
        template<bool Byteswap = false, typename Type>
        static inline char*& read(char*& buffer, Type& variable);
        template<bool Byteswap = false, typename Type, typename... Types>
        static inline char*& read(char*& buffer, Type& variable, Types&... variables);
        template<bool Byteswap = false, typename Type, std::size_t Size>
        static inline char*& read(char*& buffer, std::array<Type, Size>& container);
        template<bool Byteswap = false, unsigned int Current = 0, typename... Types>
        static inline char*& read(char*& buffer, std::tuple<Types...>& container);
        template<bool Byteswap = false>
        static inline char*& rread(char*& buffer, const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<bool Byteswap = false, typename Type>
        static inline char*& rread(char*& buffer, Type* const first, Type* const last);
        template<bool Byteswap = false, typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline char*& rread(char*& buffer, const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        ...
        template<typename Type>
        static inline unsigned int nullify(Type& variable);
        template<typename Type, typename... Types>
        static inline unsigned int nullify(Type& variable, Types&... variables);
        template<typename Type, std::size_t Size>
        static inline unsigned int nullify(std::array<Type, Size>& container);
        template<unsigned int Current = 0, typename... Types>
        static inline unsigned int nullify(std::tuple<Types...>& container);
        static inline unsigned long long int rnullify(const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<typename Type>
        static inline unsigned long long int rnullify(Type* const first, Type* const last);
        template<typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline unsigned long long int rnullify(const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    public:
        ...
        static inline unsigned int equalize(const Reference& reference);
        template<typename Reference>
        static inline unsigned int equalize(const Reference& reference, std::tuple<>&);
        template<typename Reference, typename Type>
        static inline unsigned int equalize(const Reference& reference, Type& variable);
        template<typename Reference, typename Type, typename... Types>
        static inline unsigned int equalize(const Reference& reference, Type& variable, Types&... variables);
        template<typename Reference, typename Type, std::size_t Size>
        static inline unsigned int equalize(const Reference& reference, std::array<Type, Size>& container);
        template<unsigned int Current = 0, typename Reference, typename... Types>
        static inline unsigned int equalize(const Reference& reference, std::tuple<Types...>& container);
        template<typename Reference>
        static inline unsigned long long int requalize(const Reference& reference, const std::nullptr_t = nullptr, const std::nullptr_t = nullptr);
        template<typename Reference, typename Type>
        static inline unsigned long long int requalize(const Reference& reference, Type* const first, Type* const last);
        template<typename Reference, typename Type, class = typename std::enable_if<!std::is_pointer<Type>::value>::type>
        static inline unsigned long long int requalize(const Reference& reference, const Type& first, const Type& last, typename std::iterator_traits<Type>::iterator_category* = nullptr);
        //@}
    ...
    inline bool DataHandler::read(std::istream& stream, Type& variable) {
        ...
        stream.read(reinterpret_cast<char*>(&variable), SIZEOFOCTREE);
    ...
    int DataHandler::example() {
        ...
        std::cout << std::setw(width) << "DataHandler() : ";
        DataHandler();
        std::cout << std::endl;
        std::cout << std::setw(width) << "handler = DataHandler() : ";
        handler = DataHandler();
        std::cout << std::endl;
        ...
        std::cout << std::setw(width * 2) << "i / handler.byteswap<false>(i) / i : " << handler.hexify(i);
        std::cout << " / " << handler.byteswap<false>(i) << " / ";
        std::cout << handler.hexify(i) << std::endl;
        std::cout << std::setw(width * 2) << "ptrvib ptrvie / handler.rbyteswap<false>(ptrvib, ptrvie) / ptrvib ptrvie : " << handler.rhexify(ptrvib, ptrvie);
        std::cout << " / " << handler.rbyteswap<false>(ptrvib, ptrvie) << " / ";
        std::cout << handler.rhexify(ptrvib, ptrvie) << std::endl;
        std::cout << std::setw(width * 2) << " / handler.byteswap() / : " << handler.hexify();
        std::cout << " / " << handler.byteswap() << " / ";
        std::cout << handler.hexify() << std::endl;
        std::cout << std::setw(width * 2) << "t / handler.byteswap(t) / t : " << handler.hexify(t);
        std::cout << " / " << handler.byteswap(t) << " / ";
        std::cout << handler.hexify(t) << std::endl;
        std::cout << std::setw(width * 2) << "i / handler.byteswap(i) / i : " << handler.hexify(i);
        std::cout << " / " << handler.byteswap(i) << " / ";
        std::cout << handler.hexify(i) << std::endl;
        std::cout << std::setw(width * 2) << "c i / handler.byteswap(c, i) / c i : " << handler.hexify(c, i);
        std::cout << " / " << handler.byteswap(c, i) << " / ";
        std::cout << handler.hexify(c, i) << std::endl;
        std::cout << std::setw(width * 2) << "ac0 / handler.byteswap(ac0) / ac0 : " << handler.hexify(ac0);
        std::cout << " / " << handler.byteswap(ac0) << " / ";
        std::cout << handler.hexify(ac0) << std::endl;
        std::cout << std::setw(width * 2) << "ai4 / handler.byteswap(ai4) / ai4 : " << handler.hexify(ai4);
        std::cout << " / " << handler.byteswap(ai4) << " / ";
        std::cout << handler.hexify(ai4) << std::endl;
        std::cout << std::setw(width * 2) << "tcic / handler.byteswap(tcic) / tcic : " << handler.hexify(tcic);
        std::cout << " / " << handler.byteswap(tcic) << " / ";
        std::cout << handler.hexify(tcic) << std::endl;
        std::cout << std::setw(width * 2) << "tcic ticc / handler.byteswap(tcic, ticc) / tcic ticc : " << handler.hexify(tcic, ticc);
        std::cout << " / " << handler.byteswap(tcic, ticc) << " / ";
        std::cout << handler.hexify(tcic, ticc) << std::endl;
        std::cout << std::setw(width * 2) << " / handler.rbyteswap() / : " << handler.rhexify();
        std::cout << " / " << handler.rbyteswap() << " / ";
        std::cout << handler.rhexify() << std::endl;
        std::cout << std::setw(width * 2) << "ptrvib ptrvie / handler.rbyteswap(ptrvib, ptrvie) / ptrvib ptrvie : " << handler.rhexify(ptrvib, ptrvie);
        std::cout << " / " << handler.rbyteswap(ptrvib, ptrvie) << " / ";
        std::cout << handler.rhexify(ptrvib, ptrvie) << std::endl;
        std::cout << std::setw(width * 2) << "itvib itvie / handler.rbyteswap(itvib, itvie) / itvib itvie : " << handler.rhexify(itvib, itvie);
        std::cout << " / " << handler.rbyteswap(itvib, itvie) << " / ";
        std::cout << handler.rhexify(itvib, itvie) << std::endl;
        ...
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf) : ";
        handler.write(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, t) : ";
        handler.write(ptrbuf, t);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, i) : ";
        handler.write(ptrbuf, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, c, i) : ";
        handler.write(ptrbuf, c, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, ac0) : ";
        handler.write(ptrbuf, ac0);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, ai4) : ";
        handler.write(ptrbuf, ai4);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, tcic) : ";
        handler.write(ptrbuf, tcic);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write(ptrbuf, tcic, ticc) : ";
        handler.write(ptrbuf, tcic, ticc);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rwrite(ptrbuf) : ";
        handler.rwrite(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rwrite(ptrbuf, ptrvib, ptrvie) : ";
        handler.rwrite(ptrbuf, ptrvib, ptrvie);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rwrite(ptrbuf, itvib, itvie) : ";
        handler.rwrite(ptrbuf, itvib, itvie);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf) : ";
        handler.write<true>(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, t) : ";
        handler.write<true>(ptrbuf, t);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, i) : ";
        handler.write<true>(ptrbuf, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, c, i) : ";
        handler.write<true>(ptrbuf, c, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, ac0) : ";
        handler.write<true>(ptrbuf, ac0);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, ai4) : ";
        handler.write<true>(ptrbuf, ai4);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, tcic) : ";
        handler.write<true>(ptrbuf, tcic);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.write<true>(ptrbuf, tcic, ticc) : ";
        handler.write<true>(ptrbuf, tcic, ticc);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rwrite<true>(ptrbuf) : ";
        handler.rwrite<true>(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rwrite<true>(ptrbuf, ptrvib, ptrvie) : ";
        handler.rwrite<true>(ptrbuf, ptrvib, ptrvie);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rwrite<true>(ptrbuf, itvib, itvie) : ";
        handler.rwrite<true>(ptrbuf, itvib, itvie);
        std::cout << std::endl;
        ...
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf) : ";
        handler.read(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, t) : ";
        handler.read(ptrbuf, t);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, i) : ";
        handler.read(ptrbuf, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, c, i) : ";
        handler.read(ptrbuf, c, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, ac0) : ";
        handler.read(ptrbuf, ac0);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, ai4) : ";
        handler.read(ptrbuf, ai4);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, tcic) : ";
        handler.read(ptrbuf, tcic);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read(ptrbuf, tcic, ticc) : ";
        handler.read(ptrbuf, tcic, ticc);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rread(ptrbuf) : ";
        handler.rread(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rread(ptrbuf, ptrvib, ptrvie) : ";
        handler.rread(ptrbuf, ptrvib, ptrvie);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rread(ptrbuf, itvib, itvie) : ";
        handler.rread(ptrbuf, itvib, itvie);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf) : ";
        handler.read<true>(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, t) : ";
        handler.read<true>(ptrbuf, t);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, i) : ";
        handler.read<true>(ptrbuf, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, c, i) : ";
        handler.read<true>(ptrbuf, c, i);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, ac0) : ";
        handler.read<true>(ptrbuf, ac0);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, ai4) : ";
        handler.read<true>(ptrbuf, ai4);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, tcic) : ";
        handler.read<true>(ptrbuf, tcic);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.read<true>(ptrbuf, tcic, ticc) : ";
        handler.read<true>(ptrbuf, tcic, ticc);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rread<true>(ptrbuf) : ";
        handler.rread<true>(ptrbuf);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rread<true>(ptrbuf, ptrvib, ptrvie) : ";
        handler.rread<true>(ptrbuf, ptrvib, ptrvie);
        std::cout << std::endl;
        std::cout << std::setw(width * 2) << "handler.rread<true>(ptrbuf, itvib, itvie) : ";
        handler.rread<true>(ptrbuf, itvib, itvie);
        std::cout << std::endl;
        ...
        std::cout << std::setw(width) << "handler.print(stream) : " << handler.print(stream) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, t) : " << handler.print(stream, t) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, i) : " << handler.print(stream, i) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, c, i, d) : " << handler.print(stream, c, i, d) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, ac0) : " << handler.print(stream, ac0) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, ai4) : " << handler.print(stream, ai4) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, tcic) : " << handler.print(stream, tcic) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.print(stream, tcic, ticc) : " << handler.print(stream, tcic, ticc) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.rprint(stream) : " << handler.rprint(stream) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.rprint(stream, ptrvib, ptrvie) :" << handler.rprint(stream, ptrvib, ptrvie) << std::endl;
        stream << std::endl;
        std::cout << std::setw(width) << "handler.rprint(stream, itvib, itvie) : " << handler.rprint(stream, itvib, itvie) << std::endl;
        stream << std::endl;
        stream.close();
