...
namespace magrathea {
    ...
    public:
        ...
        inline FileList(const std::initializer_list<Type>& source = std::initializer_list<Type>());
        ...
        explicit inline FileList(const ContainerType& source, const PrefixType& prefix = PrefixType());
        ...
        explicit inline FileList(const IteratorType& begin, const IteratorType& end, const PrefixType& prefix = PrefixType());
        ...
        explicit inline FileList(const FormatType& cformat, const int width = 0, const unsigned int amount = 1, const unsigned int shift = 0, const PrefixType& prefix = PrefixType());
        ...
        explicit inline FileList(Function&& f, const unsigned int amount = 1, const unsigned int shift = 0, const PrefixType& prefix = PrefixType());
        //@}
    ...
    public:
        ...
        inline FileList& operator=(Function&& f);
    ...
    public:
        ...
        inline FileList& assign(const ContainerType& source = ContainerType(), const PrefixType& prefix = PrefixType());
        template<typename IteratorType, class PrefixType = std::string, class = typename std::enable_if<(std::is_convertible<typename std::remove_reference<decltype(*std::declval<IteratorType>())>::type, std::string>::value) && (std::is_convertible<PrefixType, std::string>::value)>::type>
        inline FileList& assign(const IteratorType& begin, const IteratorType& end, const PrefixType& prefix = PrefixType());
        template<class FormatType, class PrefixType = std::string, class = typename std::enable_if<(std::is_convertible<FormatType, std::string>::value) && (std::is_convertible<PrefixType, std::string>::value)>::type>
        inline FileList& assign(const FormatType& cformat, const int width = 0, const unsigned int amount = 1, const unsigned int shift = 0, const PrefixType& prefix = PrefixType());
        template<class Function, class PrefixType = std::string, class = typename std::enable_if<(std::is_convertible<typename std::remove_reference<typename std::result_of<Function(const unsigned int)>::type>::type, std::string>::value) && !(std::is_same<typename std::decay<Function>::type, FileList>::value) && (std::is_convertible<PrefixType, std::string>::value)>::type>
        inline FileList& assign(Function&& f, const unsigned int amount = 1, const unsigned int shift = 0, const PrefixType& prefix = PrefixType());
        //@}
    ...
    public:
        ...
        template<class Function, class = typename std::enable_if<std::is_convertible<typename std::result_of<Function(std::string)>::type, bool>::value>::type>
        unsigned int count(Function&& f) const;
        template<class Function, typename FirstType = std::true_type, typename AmountType = std::true_type, class = typename std::enable_if<(std::is_convertible<typename std::result_of<Function(std::string)>::type, bool>::value) && ((std::is_same<AmountType, std::true_type>::value) || (std::is_convertible<FirstType, unsigned int>::value)) && ((std::is_same<AmountType, std::true_type>::value) || (std::is_convertible<AmountType, int>::value))>::type>
        unsigned int find(Function&& f, const FirstType first = FirstType(), const AmountType amount = AmountType()) const;
        template<class Function = std::less<std::string>, class = typename std::enable_if<std::is_convertible<typename std::result_of<Function(std::string, std::string)>::type, bool>::value>::type>
        FileList& sort(Function&& f = Function());
        template<class Function = std::less<std::string>, class = typename std::enable_if<std::is_convertible<typename std::result_of<Function(std::string, std::string)>::type, bool>::value>::type>
        bool sorted(Function&& f = Function()) const;
        template<class Function = std::equal_to<std::string>, class = typename std::enable_if<std::is_convertible<typename std::result_of<Function(std::string, std::string)>::type, bool>::value>::type>
    ...
    public:
        ...
        static inline std::string generate(const IndexType i = IndexType());
        template<class ContainerType, class = typename std::enable_if<!(std::is_convertible<ContainerType, std::string>::value) && (std::is_convertible<typename std::remove_reference<decltype(*std::begin(std::declval<ContainerType>()))>::type, std::string>::value)>::type>
        static inline std::string generate(const unsigned int i, const ContainerType& source);
        ...
        static inline std::string generate(const unsigned int i, const std::string& cformat, const WidthType width = WidthType());
        template<class Function, class = typename std::enable_if<(std::is_convertible<typename std::remove_reference<typename std::result_of<Function(const unsigned int)>::type>::type, std::string>::value) && !(std::is_same<typename std::decay<Function>::type, FileList>::value)>::type>
        static inline std::string generate(const unsigned int i, Function&& f);
