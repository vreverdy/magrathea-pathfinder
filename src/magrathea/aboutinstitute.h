...
namespace magrathea {
    ...
    class AboutInstitute final
      : public AbstractAboutObject<AboutInstitute, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string> {
        // Setup
    public:
        using AbstractAboutObject<AboutInstitute, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string>::operator=;
    ...
    public:
        template<class... Misc>
        explicit inline AboutInstitute(Misc&&... misc);
        //@}
