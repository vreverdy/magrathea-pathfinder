...
namespace magrathea {
    ...
    public:
        ...
        inline Evolution(const std::initializer_list<OtherType>& source);
        template<class OtherType, class OtherContainer>
        explicit inline Evolution(const Evolution<OtherType, OtherContainer>& source);
        template<class... Misc, class = typename std::enable_if<std::is_constructible<Container, Misc...>::value>::type>
        explicit inline Evolution(Misc&&... misc);
        //@}
    ...
    public:
        template<class OtherType>
        inline Evolution<Type, Container>& operator=(const std::initializer_list<OtherType>& source);
        template<class OtherType, class OtherContainer>
        inline Evolution<Type, Container>& operator=(const Evolution<OtherType, OtherContainer>& source);
        template<class Misc, class = typename std::enable_if<std::is_convertible<Container, typename std::remove_cv<typename std::remove_reference<Misc>::type>::type>::value>::type>
        inline Evolution<Type, Container>& operator=(Misc&& misc);
    ...
    public:
        ...
        template<class OtherType>
        inline Evolution<Type, Container>& assign(const std::initializer_list<OtherType>& source);
        template<class OtherType, class OtherContainer>
        inline Evolution<Type, Container>& assign(const Evolution<OtherType, OtherContainer>& source);
        template<class... Misc, class = typename std::enable_if<std::is_constructible<Container, Misc...>::value>::type>
        inline Evolution<Type, Container>& assign(Misc&&... misc);
        //@}
    ...
    public:
        ...
        template<class OtherType = Type, class OtherContainer = std::vector<OtherType>>
        inline Evolution<OtherType, OtherContainer> cast() const;
        //@}
    ...
    public:
        ...
        inline unsigned int index(const Iterator& it) const;
        //@}
    ...
    public:
        ...
        //@{
    public:
        inline Evolution<Type, Container>& fullclear();
        inline Evolution<Type, Container>& clear();
        template<class... Misc>
        inline Evolution<Type, Container>& resize(const Misc&... misc);
        ...
        inline Evolution<Type, Container>& append(const OtherType& value);
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const Evolution<SelfType, SelfContainer>& rhs);
        //@}
    ...
    //--------------------------------- MODIFIERS ------------------------------- //
    // Clear the contents
    /// \brief          Full clear the container.
    /// \details        Erase the container.
    /// \return         Self reference.
    template<class Type, class Container>
    inline Evolution<Type, Container>& Evolution<Type, Container>::fullclear() {
