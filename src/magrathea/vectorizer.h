...
namespace magrathea {
    ...
    public:
        ...
        static inline bool check(const FirstType& first, const SecondType& second);
        //@}
    ...
    public:
        ...
        static inline DataType& get(DataType& source, const DummyType = DummyType());
        template<typename DataType, typename DummyType = unsigned int, class = typename std::enable_if<(!std::is_base_of<Vectorizer, DataType>::value) && (std::is_convertible<DummyType, unsigned int>::value)>::type>
        static inline const DataType& get(const DataType& source, const DummyType = DummyType());
        ...
        static inline DataType& get(VectorizedType& source, const unsigned int i);
        template<class VectorizedType, class = typename std::enable_if<std::is_base_of<Vectorizer, VectorizedType>::value>::type, typename DataType = typename std::remove_reference<decltype(VectorizedType::type())>::type>
        static inline const DataType& get(const VectorizedType& source, const unsigned int i);
        //@}
    ...
    public:
        ...
        static inline VectorizedType& set(VectorizedType& destination);
        ...
        static inline VectorizedType& set(VectorizedType& destination, const GenericType& source);
        ...
        static inline VectorizedType& set(VectorizedType& destination, const GenericType& source, const First& first, const Second& second, const Others&... others);
        ...
        static inline VectorizedType& set(VectorizedType& destination, const GenericType& source, const unsigned int pos, const SizeType num = SizeType());
        ...
        static inline VectorizedType& set(VectorizedType& destination, const std::initializer_list<DataType>& source, const unsigned int pos = 0, const SizeType num = SizeType());
        ...
        static inline VectorizedType& set(VectorizedType& destination, const IteratorType& first, const IteratorType& last, const unsigned int pos = 0, const SizeType num = SizeType(), typename std::iterator_traits<IteratorType>::iterator_category* = nullptr);
        ...
        static inline VectorizedType& set(VectorizedType& destination, const GenericType& source, const MaskType& mask, const DummyType = DummyType());
        ...
        static inline VectorizedType& set(VectorizedType& destination, const std::initializer_list<DataType>& source, const MaskType& mask, const DummyType = DummyType());
        ...
        static inline VectorizedType& set(VectorizedType& destination, const IteratorType& first, const IteratorType& last, const MaskType& mask, const DummyType = DummyType(), typename std::iterator_traits<IteratorType>::iterator_category* = nullptr);
        //@}
    ...
    inline Vectorizer::~Vectorizer() = default;
    // -------------------------------------------------------------------------- //
