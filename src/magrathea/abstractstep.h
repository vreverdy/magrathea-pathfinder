...
namespace magrathea {
    ...
    public:
        ...
        explicit inline AbstractStep(const AbstractStep<OtherCrtp, OtherScalar, OtherArray, OtherTuple>& source);
        ...
        explicit inline AbstractStep(const OtherScalar& scalar, const OtherArray& array = OtherArray(), const OtherTuple& tuple = OtherTuple());
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class OtherScalar, class OtherArray, class OtherTuple>
        inline Crtp& operator=(const AbstractStep<OtherCrtp, OtherScalar, OtherArray, OtherTuple>& rhs);
        template<class OtherCrtp, class OtherScalar, class OtherArray, class OtherTuple>
        inline bool operator==(const AbstractStep<OtherCrtp, OtherScalar, OtherArray, OtherTuple>& rhs) const;
        template<class OtherCrtp, class OtherScalar, class OtherArray, class OtherTuple>
        inline bool operator!=(const AbstractStep<OtherCrtp, OtherScalar, OtherArray, OtherTuple>& rhs) const;
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class OtherScalar, class OtherArray, class OtherTuple>
        inline Crtp& assign(const AbstractStep<OtherCrtp, OtherScalar, OtherArray, OtherTuple>& source);
        template<class OtherScalar, class OtherArray = Array, class OtherTuple = Tuple, class = typename std::enable_if<(std::is_constructible<Scalar, OtherScalar>::value) && (std::is_constructible<Array, OtherArray>::value) && (std::is_constructible<Tuple, OtherTuple>::value)>::type>
        inline Crtp& assign(const OtherScalar& scalar, const OtherArray& array = OtherArray(), const OtherTuple& tuple = OtherTuple());
        //@}
    ...
    public:
        ...
        inline Type& data(Dummy...);
        template<class... Dummy, class Type = typename std::conditional<sizeof...(Dummy) == 0, std::tuple<Scalar, Array, Tuple>, void>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::conditional<sizeof...(Dummy) == 0, std::tuple<Scalar, Array, Tuple>, void>::type>::value>::type>
        inline const Type& data(Dummy...) const;
        ...
        //@{
    public:
        template<class Type = std::tuple<Scalar, Array, Tuple>, class = typename std::enable_if<std::is_convertible<Type, std::tuple<Scalar, Array, Tuple>>::value>::type>
        inline const Type& get() const;
        template<unsigned int Index, class Type = typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::value)>::type>
        inline const Type& get(Dummy...) const;
        template<unsigned int Index, unsigned int Subscript, class Type = typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::type>::value)>::type>
        inline const Type& get(const Dummy&...) const;
        template<unsigned int Index, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>()[0])>::type>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>()[0])>::type>::type>::value>::type>
        inline const Type& get(const unsigned int subscript) const;
        //@}
        ...
        //@{
    public:
        template<class Type, class = typename std::enable_if<std::is_convertible<Type, std::tuple<Scalar, Array, Tuple>>::value>::type>
        inline Crtp& set(const Type& value);
        template<unsigned int Index, class Type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::value)>::type>
        inline Crtp& set(const Type& value, Dummy...);
        template<unsigned int Index, unsigned int Subscript, class Type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::type>::value)>::type>
        inline Crtp& set(const Type& value, const Dummy&...);
        template<unsigned int Index, class Type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>()[0])>::type>::type>::value>::type>
        inline Crtp& set(const unsigned int subscript, const Type& value);
        //@}
    ...
    public:
        ...
        //@{
    public:
        template<class... Dummy, class Type = typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type>
        inline Type& core(Dummy...);
        template<class... Dummy, class Type = typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type>
        inline const Type& core(Dummy...) const;
        template<class Type, class = typename std::enable_if<std::is_convertible<Type, typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::value>::type>
        inline Crtp& core(const Type& value);
        template<unsigned int Index, class... Dummy, class Type = typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::value>::type>
        inline Type& core(Dummy...);
        template<unsigned int Index, class... Dummy, class Type = typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::value>::type>
        inline const Type& core(Dummy...) const;
        template<unsigned int Index, class Type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::value>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::tuple_element<Index, typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::type>::value>::type>
        inline Crtp& core(const Type& value);
        template<unsigned int Index, unsigned int Subscript, class... Dummy, class Type = typename std::tuple_element<Subscript, typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type, class = typename std::enable_if<Subscript + 1 <= std::tuple_size<typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::type>::value>::type>
        inline Type& core(Dummy...);
        template<unsigned int Index, unsigned int Subscript, class... Dummy, class Type = typename std::tuple_element<Subscript, typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type, class = typename std::enable_if<Subscript + 1 <= std::tuple_size<typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>::type>::value>::type>
        inline const Type& core(Dummy...) const;
        template<unsigned int Index, unsigned int Subscript, class Type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::value>::type, class = typename std::enable_if<Subscript + 1 <= std::tuple_size<typename std::tuple_element<Index, typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::type>::value>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::type>::type>::value>::type>
        inline Crtp& core(const Type& value);
        template<typename Index, class... Dummy, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type, class = typename std::enable_if<std::is_convertible<Index, unsigned int>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type>::value>::type>
        inline Type& core(const Index index, Dummy...);
        template<typename Index, class... Dummy, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type, class = typename std::enable_if<std::is_convertible<Index, unsigned int>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type>::value>::type>
        inline const Type& core(const Index index, Dummy...) const;
        template<typename Index, class Type, class = typename std::enable_if<std::is_convertible<Index, unsigned int>::value>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<!std::is_void<Type>::value, Array, void>::type>()[Index()])>::type>::type>::value>::type>
        inline Crtp& core(const Index index, const Type& value);
        template<typename Index, typename Subscript, class... Dummy, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type>()[Subscript()])>::type>::type, class = typename std::enable_if<std::is_convertible<Index, unsigned int>::value>::type, class = typename std::enable_if<std::is_convertible<Subscript, unsigned int>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type>()[Subscript()])>::type>::type>::value>::type>
        inline Type& core(const Index index, const Subscript subscript, Dummy...);
        template<typename Index, typename Subscript, class... Dummy, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type>()[Subscript()])>::type>::type, class = typename std::enable_if<std::is_convertible<Index, unsigned int>::value>::type, class = typename std::enable_if<std::is_convertible<Subscript, unsigned int>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>()[Index()])>::type>::type>()[Subscript()])>::type>::type>::value>::type>
        inline const Type& core(const Index index, const Subscript subscript, Dummy...) const;
        template<typename Index, typename Subscript, class Type, class = typename std::enable_if<std::is_convertible<Index, unsigned int>::value>::type, class = typename std::enable_if<std::is_convertible<Subscript, unsigned int>::value>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::conditional<!std::is_void<Type>::value, Array, void>::type>()[Index()])>::type>::type>()[Subscript()])>::type>::type>::value>::type>
        inline Crtp& core(const Index index, const Subscript subscript, const Type& value);
        template<unsigned int Index, typename Subscript, class... Dummy, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>()[Subscript()])>::type>::type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type, class = typename std::enable_if<std::is_convertible<Subscript, unsigned int>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>()[Subscript()])>::type>::type>::value>::type>
        inline Type& core(const Subscript subscript, Dummy...);
        template<unsigned int Index, typename Subscript, class... Dummy, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>()[Subscript()])>::type>::type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::value>::type, class = typename std::enable_if<std::is_convertible<Subscript, unsigned int>::value>::type, class = typename std::enable_if<sizeof...(Dummy) == 0>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, typename std::conditional<sizeof...(Dummy) == 0, Array, void>::type>::type>()[Subscript()])>::type>::type>::value>::type>
        inline const Type& core(const Subscript subscript, Dummy...) const;
        template<unsigned int Index, typename Subscript, class Type, class = typename std::enable_if<Index + 1 <= std::tuple_size<typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::value>::type, class = typename std::enable_if<std::is_convertible<Subscript, unsigned int>::value>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, typename std::conditional<!std::is_void<Type>::value, Array, void>::type>::type>()[Subscript()])>::type>::type>::value>::type>
        inline Crtp& core(const Subscript subscript, const Type& value);
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const AbstractStep<SelfCrtp, SelfScalar, SelfArray, SelfTuple>& rhs);
        //@}
    ...
    public:
        ...
        template<unsigned int Index, class Type = typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::value)>::type>
        static constexpr Type type(Dummy...);
        template<unsigned int Index, unsigned int Subscript, class Type = typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>::type>::value)>::type>
        static constexpr Type type(const Dummy&...);
        template<unsigned int Index, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>()[0])>::type>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Scalar, Array, Tuple>>::type>()[0])>::type>::type>::value>::type>
        static constexpr Type type(const unsigned int subscript);
        //@}
    ...
    public:
        ...
        //@{
    public:
        template<int Exponent = 1, class Coefficient = std::ratio<1>, class Type, class = typename std::enable_if<Coefficient::num + Coefficient::den != Coefficient::num>::type>
        static constexpr Type monomial(Type&& value);
        template<class Coefficient = std::ratio<1>, int Exponent = 1, class Type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (Coefficient::num + Coefficient::den != Coefficient::num)>::type>
        static constexpr Type monomial(Type&& value, Dummy...);
        template<class Output>
        static constexpr Output transmute();
        template<class Output, class Input, class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<Input>::type>::type, typename std::remove_cv<typename std::remove_reference<Output>::type>::type>::value>::type>
        static constexpr Input transmute(Input&& input);
        template<class Output, class... Input, class = typename std::enable_if<(sizeof...(Input) <= std::tuple_size<Output>::value) && (sizeof...(Input) != std::tuple_size<Output>::value)>::type>
        static constexpr Output transmute(const Input&... input);
        template<class Output, class... Input, class = typename std::enable_if<(sizeof...(Input) == std::tuple_size<Output>::value) && (sizeof...(Input) != 0)>::type>
        static constexpr Output transmute(Input&&... input);
        template<class Input>
        static constexpr bool printable(typename std::enable_if<!std::is_void<decltype(std::declval<std::ostream&>() << std::declval<Input>())>::value>::type* = nullptr);
        template<class Input, class... Dummy, class = typename std::enable_if<sizeof...(Dummy) == 0>::type>
        static constexpr bool printable(Dummy...);
        template<class Input, class = typename std::enable_if<printable<typename std::remove_cv<typename std::remove_reference<Input>::type>::type>()>::type>
        static inline bool print(std::ostream& stream, Input&& input);
        template<class Input, class = typename std::enable_if<(!printable<Input>()) && (!std::is_void<decltype(std::declval<Input>()[0])>::value) && (!std::is_void<decltype(std::declval<Input>().size())>::value)>::type>
        static inline bool print(std::ostream& stream, const Input& input);
        template<unsigned int Current = 0, class Input, class... Dummy, class = typename std::enable_if<(!printable<Input>()) && (Current <= std::tuple_size<Input>::value) && (Current != std::tuple_size<Input>::value) && (sizeof...(Dummy) == 0)>::type>
        static inline bool print(std::ostream& stream, const Input& input, Dummy...);
        template<unsigned int Current = 0, class... Dummy, class = typename std::enable_if<sizeof...(Dummy) <= 1>::type>
        static inline bool print(std::ostream& stream, const Dummy&...);
        //@}
    ...
    template<class Crtp, class Scalar, class Array, class Tuple>
    inline AbstractStep<Crtp, Scalar, Array, Tuple>::~AbstractStep() = default;
    //--------------------------------------------------------------------------- //
