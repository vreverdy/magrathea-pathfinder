...
namespace magrathea {
    ...
    class AboutPeople final
      : public AbstractAboutObject<AboutPeople, std::string, std::string, int, int, std::string, std::string, std::string, std::string> {
        // Setup
    public:
        using AbstractAboutObject<AboutPeople, std::string, std::string, int, int, std::string, std::string, std::string, std::string>::operator=;
    ...
    public:
        template<class... Misc>
        explicit inline AboutPeople(Misc&&... misc);
        //@}
