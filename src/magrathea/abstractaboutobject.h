...
namespace magrathea {
    ...
    public:
        ...
        explicit inline AbstractAboutObject(const AbstractAboutObject<OtherCrtp, OtherTypes...>& source);
        template<class... OtherTypes>
        explicit inline AbstractAboutObject(const std::tuple<OtherTypes...>& source);
        ...
        explicit inline AbstractAboutObject(const OtherTypes&... source);
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class... OtherTypes>
        inline Crtp& operator=(const AbstractAboutObject<OtherCrtp, OtherTypes...>& rhs);
        template<class... OtherTypes>
        inline Crtp& operator=(const std::tuple<OtherTypes...>& rhs);
        template<class OtherCrtp, class... OtherTypes>
        inline bool operator==(const AbstractAboutObject<OtherCrtp, OtherTypes...>& rhs) const;
        template<class OtherCrtp, class... OtherTypes>
        inline bool operator!=(const AbstractAboutObject<OtherCrtp, OtherTypes...>& rhs) const;
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class... OtherTypes>
        inline Crtp& assign(const AbstractAboutObject<OtherCrtp, OtherTypes...>& source);
        template<class... OtherTypes>
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const AbstractAboutObject<SelfCrtp, SelfTypes...>& rhs);
        //@}
    ...
    template<class Crtp, class... Types>
    inline AbstractAboutObject<Crtp, Types...>::~AbstractAboutObject() = default;
    //--------------------------------------------------------------------------- //
