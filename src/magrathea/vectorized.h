...
namespace magrathea {
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const Vectorized<SelfType, SelfSize>& rhs);
        //@}
