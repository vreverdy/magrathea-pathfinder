...
namespace magrathea {
    ...
    class HyperSphere final
      ...
      , public AbstractSubstance<HyperSphere<Dimension, Vector, Scalar>, Vector, Scalar> {
        // Setup
    public:
        using AbstractSubstance<HyperSphere<Dimension, Vector, Scalar>, Vector, Scalar>::operator=;
    ...
    public:
        template<class... Misc>
        explicit inline HyperSphere(Misc&&... misc);
        //@}
    ...
    public:
        ...
        inline Template position(Misc&&... misc);
        ...
        inline Template position(Misc&&... misc) const;
        ...
        inline Template extent(Misc&&... misc);
        ...
        inline Template extent(Misc&&... misc) const;
        //@}
