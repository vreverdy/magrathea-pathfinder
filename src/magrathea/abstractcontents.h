...
namespace magrathea {
    ...
    public:
        ...
        explicit inline AbstractContents(const AbstractContents<OtherCrtp, OtherCategory, OtherTypes...>& source);
        template<class... OtherTypes>
        explicit inline AbstractContents(const std::tuple<OtherTypes...>& source);
        ...
        explicit inline AbstractContents(const OtherTypes&... source);
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class OtherCategory, class... OtherTypes>
        inline Crtp& operator=(const AbstractContents<OtherCrtp, OtherCategory, OtherTypes...>& rhs);
        template<class... OtherTypes>
        inline Crtp& operator=(const std::tuple<OtherTypes...>& rhs);
        template<class OtherCrtp, class OtherCategory, class... OtherTypes>
        inline bool operator==(const AbstractContents<OtherCrtp, OtherCategory, OtherTypes...>& rhs) const;
        template<class OtherCrtp, class OtherCategory, class... OtherTypes>
        inline bool operator!=(const AbstractContents<OtherCrtp, OtherCategory, OtherTypes...>& rhs) const;
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class OtherCategory, class... OtherTypes>
        inline Crtp& assign(const AbstractContents<OtherCrtp, OtherCategory, OtherTypes...>& source);
        template<class... OtherTypes>
        inline Crtp& assign(const std::tuple<OtherTypes...>& source);
        template<class... OtherTypes, class = typename std::enable_if<(sizeof...(OtherTypes) != 0) && (std::is_constructible<typename std::tuple_element<0, typename std::conditional<sizeof...(Types) != 0, std::tuple<Types...>, std::tuple<std::true_type>>::type>::type, typename std::tuple_element<0, typename std::conditional<sizeof...(OtherTypes) != 0, std::tuple<OtherTypes...>, std::tuple<std::true_type>>::type>::type>::value)>::type>
        inline Crtp& assign(const OtherTypes&... source);
        //@}
    ...
    public:
        ...
        //@{
    public:
        template<class Type = std::tuple<Types...>, class = typename std::enable_if<std::is_convertible<Type, std::tuple<Types...>>::value>::type>
        inline const Type& get() const;
        template<unsigned int Index, class Type = typename std::tuple_element<Index, std::tuple<Types...>>::type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Index, std::tuple<Types...>>::type>::value)>::type>
        inline const Type& get(Dummy...) const;
        template<unsigned int Index, unsigned int Subscript, class Type = typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Types...>>::type>::type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Types...>>::type>::type>::value)>::type>
        inline const Type& get(const Dummy&...) const;
        template<unsigned int Index, class Type = typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Types...>>::type>()[0])>::type>::type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Types...>>::type>()[0])>::type>::type>::value>::type>
        ...
        //@{
    public:
        template<class Type, class = typename std::enable_if<std::is_convertible<Type, std::tuple<Types...>>::value>::type>
        inline Crtp& set(const Type& value);
        template<unsigned int Index, class Type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Index, std::tuple<Types...>>::type>::value)>::type>
        inline Crtp& set(const Type& value, Dummy...);
        template<unsigned int Index, unsigned int Subscript, class Type, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Type, typename std::tuple_element<Subscript, typename std::tuple_element<Index, std::tuple<Types...>>::type>::type>::value)>::type>
        inline Crtp& set(const Type& value, const Dummy&...);
        template<unsigned int Index, class Type, class = typename std::enable_if<std::is_convertible<Type, typename std::remove_cv<typename std::remove_reference<decltype(std::declval<typename std::tuple_element<Index, std::tuple<Types...>>::type>()[0])>::type>::type>::value>::type>
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const AbstractContents<SelfCrtp, SelfCategory, SelfTypes...>& rhs);
        //@}
    ...
    public:
        ...
        static constexpr bool categorized();
        //@}
    ...
    template<class Crtp, class Category, class... Types>
    inline AbstractContents<Crtp, Category, Types...>::~AbstractContents() = default;
    //--------------------------------------------------------------------------- //
