...
namespace magrathea {
    ...
    public:
        ...
        constexpr Wrapper(const OtherType& source = Type());
        template<typename OtherType = Type, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        constexpr Wrapper(const Wrapper<OtherType>& source);
        //@}
    ...
    public:
        template<typename OtherType = Type, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Wrapper<Type>& operator=(const OtherType& source);
        template<typename OtherType = Type, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Wrapper<Type>& operator=(const Wrapper<OtherType>& source);
        //@}
    ...
    public:
        ...
        template<typename OtherType = Type, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Type& operator()(const OtherType& source);
        template<typename OtherType = Type, class = typename std::enable_if<std::is_convertible<OtherType, Type>::value>::type>
        inline Type& operator()(const Wrapper<OtherType>& source);
        //@}
