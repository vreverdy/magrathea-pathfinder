...
namespace magrathea {
    ...
    public:
        ...
        inline DataSize& operator=(const Type& rhs);
    ...
    public:
        ...
        template<typename Type>
        inline DataSize& bytes(const Type& amount);
        template<typename Type>
        inline DataSize& kibibytes(const Type& amount);
        template<typename Type>
        inline DataSize& mebibytes(const Type& amount);
        template<typename Type>
        inline DataSize& gibibytes(const Type& amount);
        template<typename Type>
        inline DataSize& tebibytes(const Type& amount);
        template<typename Type>
        inline DataSize& pebibytes(const Type& amount);
        template<typename Type>
        inline DataSize& exbibytes(const Type& amount);
        template<typename Type>
        inline DataSize& kilobytes(const Type& amount);
        template<typename Type>
        inline DataSize& megabytes(const Type& amount);
        template<typename Type>
        inline DataSize& gigabytes(const Type& amount);
        template<typename Type>
        inline DataSize& terabytes(const Type& amount);
        template<typename Type>
        inline DataSize& petabytes(const Type& amount);
        template<typename Type>
        inline DataSize& exabytes(const Type& amount);
        template<typename Type>
        inline DataSize& bits(const Type& amount);
        //@}
