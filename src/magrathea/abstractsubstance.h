...
namespace magrathea {
    ...
    public:
        ...
        explicit inline AbstractSubstance(const AbstractSubstance<OtherCrtp, OtherTypes...>& source);
        template<class... OtherTypes>
        explicit inline AbstractSubstance(const std::tuple<OtherTypes...>& source);
        ...
        explicit inline AbstractSubstance(const OtherTypes&... source);
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class... OtherTypes>
        inline Crtp& operator=(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs);
        template<class... OtherTypes>
        inline Crtp& operator=(const std::tuple<OtherTypes...>& rhs);
        template<class OtherCrtp, class... OtherTypes>
        inline bool operator==(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs) const;
        template<class OtherCrtp, class... OtherTypes>
        inline bool operator!=(const AbstractSubstance<OtherCrtp, OtherTypes...>& rhs) const;
        //@}
    ...
    public:
        ...
        template<class OtherCrtp, class... OtherTypes>
        inline Crtp& assign(const AbstractSubstance<OtherCrtp, OtherTypes...>& source);
        template<class... OtherTypes>
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const AbstractSubstance<SelfCrtp, SelfTypes...>& rhs);
        //@}
    ...
    template<class Crtp, class... Types>
    inline AbstractSubstance<Crtp, Types...>::~AbstractSubstance() = default;
    //--------------------------------------------------------------------------- //
