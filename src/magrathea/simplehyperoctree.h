...
// CONTRIBUTIONS :  [Vincent Reverdy (2012-2021), Michel-Andrès Breton (2015-2016)]
...
namespace magrathea {
    ...
    public:
        ...
        inline Element& operator()(Types&&... iposs);
        template<typename... Types, class = typename std::enable_if<(sizeof...(Types) != 0)>::type, class = typename std::enable_if<((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Type>::value) ? (sizeof...(Types) == Dimension) : (sizeof...(Types) == 1)) && (!std::is_same<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Index>::value)>::type>
        inline const Element& operator()(Types&&... iposs) const;
        //@}
    ...
    public:
        ...
        template<typename Iterator = decltype(std::declval<const Container>().rbegin()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline Iterator rbegin() const;
        template<typename Iterator = decltype(std::declval<Container>().crbegin()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline Iterator crbegin() const;
        template<typename Iterator = decltype(std::declval<Container>().rend()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline Iterator rend();
        template<typename Iterator = decltype(std::declval<const Container>().rend()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline Iterator rend() const;
        template<typename Iterator = decltype(std::declval<Container>().crend()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        ...
        inline unsigned long long int index(const Iterator& it) const;
        //@}
    ...
    public:
        template<typename Iterator = decltype(std::declval<Container>().begin()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline Iterator find(const Index& idx);
        template<typename Iterator = decltype(std::declval<const Container>().begin()), class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline Iterator find(const Index& idx) const;
        ...
        inline Iterator locate(Types&&... iposs);
        ...
        inline Iterator locate(Types&&... iposs) const;
        //@}
    ...
    public:
        ...
        //@{
    public:
        inline SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>& fullclear();
        ...
        template<class... Misc>
        inline SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>& append(Misc&&... misc);
        template<class... Misc>
        inline SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>& resize(Misc&&... misc);
    ...
    public:
        ...
        template<typename Iterator, class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline bool root(const Iterator& it);
        template<typename Iterator, class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline bool leaf(const Iterator& it);
        template<typename Iterator, class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>& refine(const Iterator& it);
        template<typename Iterator, class = typename std::enable_if<std::is_convertible<typename std::remove_cv<typename std::remove_reference<decltype(*std::declval<Iterator>())>::type>::type, Element>::value>::type>
        inline SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>& coarsen(const Iterator& it);
        //@}
    ...
    public:
        template<typename... Types, class = typename std::enable_if<(sizeof...(Types) != 0)>::type, class = typename std::enable_if<((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Type>::value) ? (sizeof...(Types) == Dimension) : (sizeof...(Types) == 1)) && (!std::is_same<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Index>::value)>::type>
        inline Data ngp(Types&&... iposs) const;
        template<typename... Types, class = typename std::enable_if<(sizeof...(Types) != 0)>::type, class = typename std::enable_if<((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Type>::value) ? (sizeof...(Types) == Dimension) : (sizeof...(Types) == 1)) && (!std::is_same<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Index>::value)>::type>
        inline Data cic(Types&&... iposs) const;
        template<typename... Types, class = typename std::enable_if<(sizeof...(Types) != 0)>::type, class = typename std::enable_if<((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Type>::value) ? (sizeof...(Types) == Dimension) : (sizeof...(Types) == 1)) && (!std::is_same<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Index>::value)>::type>
        inline Data tsc(Types&&... iposs) const;
        template<typename... Types, class = typename std::enable_if<(sizeof...(Types) != 0)>::type, class = typename std::enable_if<((std::is_convertible<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Type>::value) ? (sizeof...(Types) == Dimension) : (sizeof...(Types) == 1)) && (!std::is_same<typename std::tuple_element<0, std::tuple<typename std::remove_cv<typename std::remove_reference<Types>::type>::type...>>::type, Index>::value)>::type>
        inline Data tsc(std::vector<Element>& elemsTsc, Types&&... iposs) const;
        //@}
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& lhs, const SimpleHyperOctree<SelfType, SelfIndex, SelfData, SelfDimension, SelfPosition, SelfExtent, SelfElement, SelfContainer>& rhs);
        //@}
    ...
    public:
        ...
        //@{
    public:
        template<class Template, class Tuple, typename... Kinds, class = typename std::enable_if<(sizeof...(Kinds) + 1 <= std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value)>::type>
        static constexpr Template tupleify(Tuple&& tuple, Kinds&&... values);
        template<class Template, class Tuple, typename... Kinds, class = typename std::enable_if<(sizeof...(Kinds) == std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value)>::type>
        static constexpr Template tupleify(const Tuple& tuple, Kinds&&... values);
        template<class Template, typename... Kinds, class = typename std::enable_if<std::is_convertible<typename std::tuple_element<0, typename std::conditional<static_cast<bool>(sizeof...(Kinds)), std::tuple<typename std::remove_cv<typename std::remove_reference<Kinds>::type>::type...>, std::tuple<Template>>::type>::type, typename std::tuple_element<0, typename std::conditional<static_cast<bool>(sizeof...(Kinds)), Template, std::tuple<Template>>::type>::type>::value>::type>
        static constexpr Template tupleify(Kinds&&... values);
        template<class Template, class Function, class Tuple, typename... Kinds, class = typename std::enable_if<(sizeof...(Kinds) + 1 <= std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value)>::type>
        static constexpr Template variadify(Function&& f, Tuple&& tuple, Kinds&&... values);
        template<class Template, class Function, class Tuple, typename... Kinds, class = typename std::enable_if<(sizeof...(Kinds) == std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value)>::type>
        static constexpr Template variadify(Function&& f, const Tuple& tuple, Kinds&&... values);
        template<class Template, class Function, typename... Kinds, class = typename std::enable_if<(!std::is_void<typename std::result_of<Function(Kinds...)>::type>::value) || (std::is_void<typename std::result_of<Function(Kinds...)>::type>::value)>::type>
        static constexpr Template variadify(Function&& f, Kinds&&... values);
        template<unsigned int Step = 0, class Object, typename Kind, class = typename std::enable_if<(Step <= std::tuple_size<typename std::remove_cv<typename std::remove_reference<decltype(std::declval<Object>().data())>::type>::type>::value)>::type>
        static constexpr Object& mac(Object& accumulator, const Object& factor, const Kind coefficient);
        template<unsigned int Step = 0, class Tuple, typename Kind, class Dummy = std::nullptr_t, class = typename std::enable_if<(Step <= std::tuple_size<typename std::remove_cv<typename std::remove_reference<Tuple>::type>::type>::value)>::type>
        static constexpr Tuple& mac(Tuple& accumulator, const Tuple& factor, const Kind coefficient, Dummy&& = Dummy());
        template<class Regular, typename Kind, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (std::is_convertible<Kind, Regular>::value)>::type>
        static constexpr Regular& mac(Regular& accumulator, const Regular& factor, const Kind coefficient, Dummy...);
        template<class Irregular, typename Kind, class... Dummy, class = typename std::enable_if<(sizeof...(Dummy) == 0) && (!std::is_convertible<Kind, Irregular>::value)>::type>
        static constexpr Irregular& mac(Irregular& accumulator, const Irregular& factor, const Kind coefficient, const Dummy...);
        //@}
    ...
    //--------------------------------- MODIFIERS ------------------------------- //
    // Clear the contents
    /// \brief          Full clear the content.
    /// \details        Erase the hyperoctree.
    /// \return         Self reference.
    template<typename Type, class Index, class Data, unsigned int Dimension, class Position, class Extent, class Element, class Container>
    inline SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>& SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>::fullclear() {
        ...
        do {
            ...
            if (!idx.invalidated()) {
                for (unsigned int idim = 0; idim < Index::dimension(); ++idim) {
                    dist[idim] = std::abs((idx.template center<Type, Position, Extent>(idim) - point[idim]) / (half + half));
                }
                for (unsigned int isite = 0; isite < Index::sites(); ++isite) {
    ...
    /// \brief          Triangular Shaped Cloud interpolation.
    /// \details        Computes the value of the data at the provided position
    ///                 using a triangular shaped cloud interpolation scheme.
    /// \tparam         Types (Scalar position types.)
    /// \param[in]      iposs Real positions along each dimension.
    /// \return         Value of the data at the provided position.
    template<typename Type, class Index, class Data, unsigned int Dimension, class Position, class Extent, class Element, class Container>
    ...
    /// \details        Computes the value of the data at the provided position
    ///                 using a triangular shaped cloud interpolation scheme.
    ///		    Also use previsouly computed neighbouring cells
    /// \tparam         Types (Scalar position types.)
    /// \param[in]      elemsTsc Neighbouring cells previsouly computed
    /// \param[in]      iposs Real positions along each dimension.
    /// \return         Value of the data at the provided position.
    template<typename Type, class Index, class Data, unsigned int Dimension, class Position, class Extent, class Element, class Container>
    template<typename... Types, class, class>
    ...
    int SimpleHyperOctree<Type, Index, Data, Dimension, Position, Extent, Element, Container>::example() {
        ...
        std::cout << std::setw(width * 3) << "SimpleHyperOctree<double, SimpleHyperOctreeIndex<unsigned long long int, 3>, double>() : ";
        SimpleHyperOctree<double, SimpleHyperOctreeIndex<unsigned long long int, 3>, double>();
        std::cout << std::endl;
        std::cout << std::setw(width * 3) << "SimpleHyperOctree<double, SimpleHyperOctreeIndex<unsigned long long int, 3>, double>(0, 4) : ";
        SimpleHyperOctree<double, SimpleHyperOctreeIndex<unsigned long long int, 3>, double>(0, 4);
        std::cout << std::endl;
        ...
        std::cout << std::setw(width * 2) << "octree().reserve(16) : ";
        octree().reserve(16);
        std::cout << std::endl;
        ...
        std::cout << std::setw(width) << "octree.assign() : ";
        octree.assign();
        std::cout << std::endl;
        std::cout << std::setw(width) << "octree.assign(0, 4) : ";
        octree.assign(0, 4);
        std::cout << std::endl;
        std::cout << std::setw(width) << "octree.assign(octree) : ";
        octree.assign(octree);
        std::cout << std::endl;

        // Management
        std::cout << std::endl;
        std::cout << std::setw(width) << "Management : " << std::endl;
        std::cout << std::setw(width) << "octree.nullify() : ";
        octree.nullify();
        std::cout << std::endl;
        std::cout << std::setw(width) << "octree.copy() : ";
        octree.copy();
        std::cout << std::endl;
        std::cout << std::setw(width) << "octree.cast() : ";
        octree.cast();
        std::cout << std::endl;
        ...
        std::cout << std::setw(width) << "operator<<(stream, octree) : ";
        stream << octree;
        std::cout << std::endl;
