...
class Gravity final
: public magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>>
{
    // Setup 
    public: using magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>>::operator=; 
    ...
    //@{
    public: 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<0, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template rho(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<0, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template rho(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<1, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template phi(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<1, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template phi(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidxyz(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidxyz(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(0, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidx(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(0, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidx(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(1, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidy(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(1, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidy(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(2, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidz(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<2, Values...>(2, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidz(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<3, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template a(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<3, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template a(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<4, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidt(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<4, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template dphidt(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vxyz(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vxyz(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(0, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vx(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(0, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vx(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(1, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vy(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(1, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vy(Misc&&... misc) const; 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(2, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vz(Misc&&... misc); 
        template <unsigned int... Values, class... Misc, class Template = decltype(std::declval<const magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>> >().template data<5, Values...>(2, std::declval<Misc>()...)), class = typename std::enable_if<!std::is_void<Template>::value>::type> inline Template vz(Misc&&... misc) const; 
    //@}
...
: magrathea::AbstractContents<Gravity<Type, Dimension>, magrathea::EulerianCategory, Type, Type, std::array<Type, Dimension>, Type, Type, std::array<Type, Dimension>>(std::forward<Misc>(misc)...)
{
    ;
}
// -------------------------------------------------------------------------- //
...
/// \details        Provides an immutable access to the dphidt data by forwarding 
///                 parameters to the unified base accessor member. 
/// \tparam         Values List of template values. 
/// \tparam         Misc (Miscellaneous types.) 
/// \tparam         Template (Deduced template type.) 
