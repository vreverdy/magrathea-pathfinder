...
class TReadHDF5 {
	...
	template <typename T> static hid_t h5t_native(void); 
	...
	// Get data
	template < typename Type > static void get_data_from_dataset(const hid_t& gid , const std::string& output_name, std::vector<Type>& output); 
	template < typename Type, typename... String, typename... Vector > static void get_data_from_dataset(const hid_t& gid , const std::string& output_name, std::vector<Type>& output, const String&... output_names, Vector&... outputs);
	// Count
	template < typename Integer > static void cellsPerLevels(const std::string& fileName, std::vector<Integer>& count); 
	template < class Parameter, typename Integer, class Conic > static void cellsAndCubesPerLevels(const Parameter& parameters, const std::string& fileName, std::vector< Integer >& count, std::vector< std::vector < std::string > >& cubeNumber, const double& thetay, const double& thetaz, const Conic& conic);


	// Attributes at file level 
	template < typename Type > static void getAttribute(const std::string& fileName, const std::string& attributeName, Type& attributeValue); 
	template < typename Type > static void getAttribute(const std::string& fileName, const std::string& attributeName, std::vector<Type>& attributeValue); 

	// Attributes on group
	template < typename Type > static void getAttribute(const std::string& fileName, const std::string& attributeName1, const std::string& attributeName2, Type& attributeValue); 
	template < typename Type > static void getAttribute(const std::string& fileName, const std::string& attributeName1, const std::string& attributeName2, std::vector<Type>& attributeValue); 

	// Read and fill gravity cell vectors
	// Full sample
	template < typename Type > static void fillVectors_grav(const std::string& fileName, const unsigned int& levelMin, const unsigned int& levelMax, const std::string& output_name, std::vector<Type>& output);
	template < typename Type, typename... String, typename... Vector > static void fillVectors_grav(const std::string& fileName, const unsigned int& levelMin, const unsigned int& levelMax, const std::string& output_name, std::vector<Type>& output, const String&... output_names, Vector&... outputs);
	// Selected sample
	template < typename Type > static void fillVectors_grav(const std::string& fileName, const unsigned int& levelMin, const unsigned int& levelMax, const std::vector< std::string >& cubeNumber, const std::string& output_name,std::vector<Type>& output);
	template < typename Type, typename... String, typename... Vector > static void fillVectors_grav(const std::string& fileName, const unsigned int& levelMin, const unsigned int& levelMax, const std::vector< std::string >& cubeNumber, const std::string& output_name,std::vector<Type>& output, const String&... output_names, Vector&... outputs);
	// Read and fill particle vectors
	// Full sample
	template < typename Type > static void fillVectors_part(const std::string& fileName, const std::string& fileSide, const std::string& output_name, std::vector<Type>& output);
	template < typename Type, typename... String, typename... Vector > static void fillVectors_part(const std::string& fileName, const std::string& fileSide, const std::string& output_name, std::vector<Type>& output, const String&... output_names, Vector&... outputs);
	// Random sample
	template < typename Type > static void fillVectors_part(const double& fraction, const std::string& fileName, const std::string& fileSide, const std::string& output_name, std::vector<Type>& output);
	template < typename Type1, typename Type2 > static void fillVectors_part(const double& fraction, const std::string& fileName, const std::string& fileSide, const std::string& output_name1, std::vector<Type1>& output1, const std::string& output_name2, std::vector<Type2>& output2);
	template < typename Type1, typename Type2, typename Type3 > static void fillVectors_part(const double& fraction, const std::string& fileName, const std::string& fileSide, const std::string& output_name1, std::vector<Type1>& output1, const std::string& output_name2, std::vector<Type2>& output2, const std::string& output_name3, std::vector<Type3>& output3);
	// Selected sample
	template < class Parameter, typename Type, class Conic > static void fillVectors_part(const Parameter& parameters, const std::string& fileName, const double& thetay, const double& thetaz, const Conic& conic, const std::string& fileSide, const std::string& output_name, std::vector<Type>& output);
	template < class Parameter, typename Type, typename... String, typename... Vector, class Conic > static void fillVectors_part(const Parameter& parameters, const std::string& fileName, const double& thetay, const double& thetaz, const Conic& conic, const std::string& fileSide, const std::string& output_name, std::vector<Type>& output, const String&... output_names, Vector&... outputs);
...
void TReadHDF5::pos_from_index_fullsky(const std::string& str, const std::vector<int>& nctab, const std::vector<float>& dimtab, const float& cubesize, std::array<double, 3>&  point111) {
    ...
    const int iy1 = index%(nctab[0]*nctab[1]) == 0 ? (dimtab[0]+ihy)/cubesize + 1 : index%nctab[0]!=0 ? index/nctab[0] +1 : index/nctab[0];
    index = index%nctab[0];
...
void TReadHDF5::fillVectors_grav(const std::string& fileName, const unsigned int& levelMin, const unsigned int& levelMax, const std::string& output_name, std::vector<Type>& output){
	...
	const std::vector<std::string> levels = {"level00","level01","level02","level03","level04","level05","level06","level07","level08"
					,"level09","level10","level11","level12","level13","level14","level15", "level16","level17","level18"
